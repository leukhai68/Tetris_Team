...
# thêm include của thư mục "Code Duy" (dấu cách phải escape: \ )
INCLUDE_PATHS = -I. -I$(RAYLIB_PATH)/src -I$(RAYLIB_PATH)/src/external -ICodeDuy
...
# Chỉ build các file trong CodeDuy (trong đó có main.cpp)
OBJS := $(wildcard CodeDuy/*.cpp)
